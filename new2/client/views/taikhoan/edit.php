    ...
    <?php
        ...
        <div class="main-content">
            <div class="container mt-7">
                ...
                </div> --> <form method="post" action="?act=editacc">
                                </div>
                            </div>
                            <div class="card-body">
                                <form>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" id="input-email"
                                                        class="form-control form-control-alternative"
                                                        placeholder="Null" value="<?=$password?>" name="password">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" id="input-email"
                                                        class="form-control form-control-alternative"
                                                        placeholder="Null" value="<?=$email?>" name="email">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group focused">
                                                    ...
                                                    <input type="text" id="input-first-name"
                                                        class="form-control form-control-alternative"
                                                        placeholder="Null" value="<?=$fullname?>" name="fullname">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group focused">
                                                    ...
                                                    <input type="text" id="input-last-name"
                                                        class="form-control form-control-alternative"
                                                        placeholder="Null" value="<?=$phone_number?>" name="phone_number">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group focused">
                                                    ...
                                                    <input id="input-address"
                                                        class="form-control form-control-alternative"
                                                        placeholder="Null" value="<?=$address?>" 
                ...
                <div class="col-xl-6 m-auto text-center">
                    <div class="copyright">
                        <div class="col-12 ">
                            ...
                            <input type="submit"  name="gui"  class="btn btn-sm btn-primary" value="Save">
