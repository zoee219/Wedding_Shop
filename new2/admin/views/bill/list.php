                                        ...
                                        <td>
                                            <div class="d-flex justify-content-left align-items-center">
                                                <div class="d-flex flex-column">
                                                    <a href="?act=ctbill&id=<?=$bill['id_bill']?>"><span class="text-truncate fw-bold"><?=$bill['bill_name']?></span></a>
                                                </div>
                                            </div>
                                        </td>
                                        <td><?=$bill['bill_address']?></td>
                                        <td><?=$bill['bill_tel']?></td>
                                        <input type="hidden" name="" value="<?=$bill['id_bill']?>">
                                        <td><span class="badge badge-danger"><?=$bill['booking_date']?></span></td>
                                        <td class="text-center"><?=status($bill['id_status'],$bill['name_status'])?></td>
                                    </tr>
                                    <?php endforeach;?>
                                </tbody>
